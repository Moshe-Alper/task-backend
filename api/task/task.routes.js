...
import { getTasks, getTaskById, addTask, updateTask, removeTask, clearAllTasks, startTask, toggleWorker, getWorkerStatus, checkIndexes } from './task.controller.js'
...
router.get('/indexes', checkIndexes)
